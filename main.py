...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        pixmap_upload = icon_upload.pixmap(128, 128)  
        ...
        pixmap_pressure = icon_pressure.pixmap(256, 256)  
        ...
        pixmap_spo2 = icon_spo2.pixmap(256, 256)  
        ...
        pixmap_temp = icon_temp.pixmap(256, 256)  
    ...
    def toggle_alarm(self):
        ...
        if self.alarmPlayer.state() == QMediaPlayer.PlayingState:
            ...
            pixmap_of_alarm = off_icon.pixmap(256, 256)  
            ...
            pixmap_on_alarm = on_icon.pixmap(256, 256)  
